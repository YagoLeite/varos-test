    ...
    <div className="w-full h-full flex flex-grow justify-center items-center ">
      <div className="w-full overflow-hidden h-fit ">
        <AnimatedWrapper from="left">
          <div className="w-full max-w-[664px]  flex flex-col mobile:items-center tablet:items-start desktop:items-start gap-[24px]">
            <h1 className="font-extrabold  text-[38px] tablet:text-[50px] desktop:text-[64px] mobile:text-center tablet:text-start desktop:text-start ">
              Investir de forma mais inteligente passa por aqui.
            </h1>
            <p className="font-semibold text-[18px] max-w-[469px] mobile:text-center tablet:text-start desktop:text-start">
              Fazemos de tudo para que você possa conquistar seus sonhos da
              melhor forma possível.
            </p>

            <CircleFillButton />
            <div className="rounded-[24px] border w-full border-featuredCardGray py-[20px] mt-[80px] ">
              <Marquee>
          ...
          <div className="w-full  flex flex-col gap-[70px]  items-start pb-[15px]  ">
            ...
            <div className="relative ">
              <FeaturedCards style={{ marginLeft: "10px" }}>
                ...
                <p>
                  Codigo.<span className="text-customTurquoise">py</span>
                </p>
              </FeaturedCards>

...
const data: string[] = [
  ...
  "Eu acompanho vários gestores de fundo e educadores financeiros. Tu de longe és um dos que mais contribui para minha construção de conhecimento. A forma que colocas coisas que outras pessoas fazem parecer complexas de uma forma super simples e ginal.",
...
function CarouselCard({ position }: CarouselCardProps) {
  return (
    <motion.div
      ...
      animate="animate"
      exit="exit"
      className="bg-featuredCardBlack border rounded-[24px] border-secondGray desktop:w-[372px] tablet:w-[372px] mobile:w-full h-fit min-h-[380px] flex jusitfy-center items-center px-[48px] py-[10px] "
    >
      <div className="flex flex-col gap-[16px] w-full h-fit  ">
        ...
        <p className="text-[18px] font-[500] ">{data[position]}</p>

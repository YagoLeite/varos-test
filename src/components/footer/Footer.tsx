...
const Footer = () => {
  return (
    <div className="h-full w-full gap-[20px] flex mobile:flex-col tablet:flex-col desktop:flex-row   ">
      ...
      <div className="flex justify-center w-full items-center">
        <div className="flex gap-[24px] flex-wrap w-full max-w-[858px] justify-between ">
